...
<p class="consent-text"><strong>PAYMENTS:</strong> You will receive $1.70 as payment for your participation, as well as a bonus of up to $0.50 depending on your performance.</p>
...
<p class="consent-text"><emph>Questions:</emph> If you have any questions, concerns or complaints about this research, its procedures, risks and benefits, contact <strong>Ben Prystawski</strong> (<a href="mailto://benpry@stanford.edu">benpry@stanford.edu</a>) the Protocol Director, Noah Goodman (ngoodman@stanford.edu).</p>
...
const instructionPages = [
  ...
  <p class='instructions-text'>In the experiment, there is a population of five people: Alice, Bob, Charlie, Daniel, and Eve. Many rumors spread among these people. Some people talk with each other a lot and other people never talk with each other, so <strong>knowing whether one person knows a rumor tells you about whether other people know it</strong>. Your job is to learn the pattern of who shares information with whom from these rumors.</p>
  <p class='instructions-text'>For each rumor, you will see a pair of people and whether they know about the rumor or not. Here is an example of what observing a rumor looks like:</p>
  ...
  <p class="instructions-text">You will earn a bonus of <strong>1¢ for every correct answer.</strong>
